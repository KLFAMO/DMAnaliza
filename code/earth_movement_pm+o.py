...
while mjd_start < mjd_stop:
    ev_x.append(earth_velocity(mjd_start, xyz_list=[6378137, 0, 0])[0])
    evf_x.append(earth_velocity_fast(mjd_start)[0])
    mjd_start = mjd_start + step


print('ev =', ev_x, 'evf =', evf_x)'''
